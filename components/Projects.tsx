            ...
            <div className="flex-row flex mb-5">
              ...
              <div className="p-3">
                ...
                <p className="text-gray-500 text-[10px]">
                  Web App that meets all the necessary regulations for natural
                  gas operators in the state of Georgia
                </p>
              </div>
            </div>
          </Link>
        ...
        <div className="flex-col flex md:flex-row ">
          ...
          >
            <div className="flex-row flex mb-5">
              ...
              />
              <div className=" p-3 ">
                <p className="text-white font-semibold text-xl">Fashionavia</p>
                <p className="text-gray-500 text-[10px]">
